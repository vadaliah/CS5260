...
# Confusion Matrix
  As described above VWAP analysis is a time series analysis and depends on number of available datapoints in each bucket. We will use k-means clustering to determine number of data points for Ticker(currencypair) and business date complex key.
# References
